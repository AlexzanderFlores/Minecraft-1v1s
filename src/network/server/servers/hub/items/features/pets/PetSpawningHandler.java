...
import network.server.servers.hub.items.features.pets.entities.ChickenPet;
import network.server.servers.hub.items.features.pets.entities.CowPet;
import network.server.servers.hub.items.features.pets.entities.HorsePet;
import network.server.servers.hub.items.features.pets.entities.MagmaCubePet;
import network.server.servers.hub.items.features.pets.entities.MushroomCowPet;
import network.server.servers.hub.items.features.pets.entities.OcelotPet;
import network.server.servers.hub.items.features.pets.entities.PigPet;
import network.server.servers.hub.items.features.pets.entities.SheepPet;
import network.server.servers.hub.items.features.pets.entities.SlimePet;
import network.server.servers.hub.items.features.pets.entities.SnowmanPet;
import network.server.servers.hub.items.features.pets.entities.SquidPet;
import network.server.servers.hub.items.features.pets.entities.WolfPet;
